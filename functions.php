...
if ( ! function_exists( 'avocado_setup' ) ) :
	...
	function avocado_setup() {
        ...
        register_nav_menu('primary',__('Main Menu', 'avocado'));
        
    register_nav_menus( array(
        "footer-left" => __("Footer Left Menu", "avocado"),
        "footer-middle" => __("Footer Middle Menu", "avocado"),
        "footer-right" => __("Footer Right Menu", "avocado"),
    ));
...
function avocado_widgets_init() {
	register_sidebar(array(
        'name' => __('Footer About', 'avocado'),
        'id'   => 'footer-side',
        'description'   => __('footer side', 'avocado'),
    ...
    register_sidebar(array(
        'name' => __('Footer Bottom Copyright', 'avocado'),
        'id' => 'footer-bottom',
        'description' => __('footer section, bottom side', 'avocado'),
        'before_widget' => '<div id="%1$s" class="%2$s">',
        'after_widget' => '</div>',
        'before_title' => '',
        'after_title' => '',
	...
	register_sidebar(array(
        'name' => __('Product Archive Sidebar', 'avocado'),
        'id' => 'avocado_woocommerce',
        'description' => __('add widget here.', 'avocado'),
